...
>
	<div
		class={`${sizeClasses[size]} max-h-[90vh] transform overflow-y-auto rounded-2xl bg-white shadow-2xl transition-all duration-300`}
	...
	>
		<div class="sticky top-0 z-20 border-b border-gray-100 bg-white p-6 pb-4">
			<div class="flex items-center justify-between">
				<h2
					id="modal-title-{Math.random().toString(36).substring(2, 9)}"
