    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div class="mt-2">
        ...
        <nav class="flex flex-col gap-1">
          ...
          <a href="/dashboard/aiChat" class={`flex items-center px-4 py-2 rounded-md transition ${isActive('/dashboard/aiChat') ? 'bg-blue-100 text-blue-700' : 'hover:bg-blue-100 hover:text-blue-700'}`} aria-current={isActive('/dashboard/aiChat') ? 'page' : undefined}>
            <img src="/icons/svg/robot-svgrepo-com.svg" class="w-8 h-8" alt="AI" />
