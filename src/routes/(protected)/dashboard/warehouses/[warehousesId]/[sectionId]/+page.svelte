    ...
    >
        <div class="flex w-full flex-col items-center gap-4 md:flex-row">
            <div class="w-60 md:flex-[3] lg:flex-[4]">
                <SearchBar bind:search placeholder="Search by name or description..." extraClasses="w-full" />
            </div>
...
>
    <form 
        ...
        class="space-y-4"
    >
        <TextInput name="name" required placeholder="Row Name" />
